...
#check for quantitative variables' normality and find that:
...
#Quantitative variables for log transformation
#Some independent variables look like good candidates for log transformation: 
# TotalBsmtSF, KitchenAbvGr, LotFrontage, LotArea and others. 
# While ganining on regression transformation will smooth out some irregularities which could be important like large amount of houses with 0 2ndFlrSF. 
